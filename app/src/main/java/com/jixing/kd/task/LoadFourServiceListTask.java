...
import com.jixing.kd.bean.FourServerListBean;
import com.jixing.kd.bean.User;
import com.jixing.kd.db.FourServiceContentProvider;
import com.jixing.kd.db.FourTypeService;
            ...
            if (response.has("err_code")) {
                try {
                    ...
                    if (TextUtils.equals(code, "0")) {
                        Log.e(TAG, "processData: response is " + response.toString());
                        Gson gson = new Gson();
